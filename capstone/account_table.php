                            ...
                            <td>
                                <form action="process.php" method="POST">
                                    <div class="text-center">
                                        <button class="btn btn-success" type="submit" name="reset_pass" onclick="return confirm('Are you sure you want to reset password of <?= $row['firstname']; ?>?');" value="<?= $row['id']; ?>">Reset Password</button>
                                    </div>
                                </form>
                            </td>
                        </tr>
