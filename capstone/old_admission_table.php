...
<li class="submenu">
  ...
  <li><a class="active" href="old_admission_table.php"><span>Readmission</span></a></li>
  </ul>
</li>
<li class="">
    ...
    <div class="table-responsive">
        <table id="myTable" class="table custom-table text-center"> 
            ...
            <tbody>
                ...
                $query2 = "SELECT * FROM old_admission";
