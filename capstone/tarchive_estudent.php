...
<li class="submenu">
  <a href="#"><img src="assets/img/sidebar/icon-3.png" alt="icon"><span> Archive </span> <span class="menu-arrow"></span></a>
    ...
    <li class="active"><a href="tarchive_estudent.php"><span>Enrolled</span></a></li>
  </ul>
</li>
<li class="">
...
<div class="card-body">
    <div class="row">
        ...
        $(document).ready(function() {
            var table = $('#earchiveTable').DataTable({
                "paging": true,
                "searching": true,
                "info": true,
                "ordering": true,
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <select id="gradeFilter" class="form-control" style="width: 200px;">
            ...
            <div class="table-responsive">
                <!-- Add the id="earchiveTable" for DataTable initialization -->
                <table id="earchiveTable" class="table custom-table">
                    <thead class="thead-light">
                        <tr>
