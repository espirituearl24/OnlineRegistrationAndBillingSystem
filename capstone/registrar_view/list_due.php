...
<li class="submenu">
  ...
  <li><a class="active text-decoration-underline text-black" href="list_due.php"><span>New Admissions <span class="badge rounded-pill text-bg-danger"> <?php echo $admissionCount; ?></span></span></a></li>
...
$(document).ready(function() {
    ...
    <div class="table-responsive">
        <table id="myTable" class="table custom-table text-center"> 
            ...
            <tbody>
                ...
                $query2 = "SELECT admission.*, payments.* 
           FROM admission 
           LEFT JOIN payments ON admission.id = payments.admission_id";
                ...
                ?>
                    ...
                    <td><?= $row2['id']; ?></td>
                        ...
                        <td>
    <a href="email.php?email=<?= urlencode($row2['emailaddress']); ?>" class="text-info">
        <?= $row2['emailaddress']; ?>
    </a>
</td>
                        <td><?= $row2['grade']; ?></td>
    ...
    <button type="submit" name="save_enroll" class="btn btn-success btn-sm mb-1" value="<?= $row2['id']; ?>">
