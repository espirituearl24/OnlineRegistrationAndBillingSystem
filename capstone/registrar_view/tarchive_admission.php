...
<li class="submenu">
  <a class="active" href="javascript:void(0);"><img src="assets/img/sidebar/icon-3.png" alt="icon"><span> Archive </span> <span class="menu-arrow"></span></a>
    <ul class="list-unstyled" style="display: none;">
    <li ><a class="active text-decoration-underline text-black" href="tarchive_admission.php"><span>Admission</span></a></li>
...
<div class="card-body">
    ...
    <!-- Table Start -->
    <div class="table-responsive">
        <table id="archiveTable" class="table custom-table text-center">
            <thead class="thead-light">
                <tr>
            ...
            <tbody>
                <?php
                    $query3 = "SELECT * FROM archive_admission";
                ...
                <tr>
                    ...
                    <td class="text-center"><?= $row3['currentdate']; ?></td>
                    <td class="text-center">
                        <form action="process.php" method="POST">
                            ...
                            <button type="submit" name="recover_admission" class="btn btn-primary btn mb-1" onclick="return confirm('Are you sure you want to recover this data?');" value="<?= $row3['id']; ?>">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <b>Last Grade Level: </b><?= $row3['lastGradelevel']; ?><br>
                                                    <b>Last S.Y.: </b><?= $row3['lastSY']; ?><br>
                                                    <b>Last School: </b><?= $row3['lastSchool']; ?><br>
                                                    <b>School Address: </b><?= $row3['schoolAddress']; ?><br>
                                                    <b>School Type: </b><?= $row3['schoolType']; ?>
                                                </div>
                                                <div class="col">
                                                    <b>Special Educational Needs?: </b><?= $row3['specialED']; ?><br>
                                                    <b>With LRN? </b><?= $row3['withLRN']; ?><br><br>
                                                    <b>Father's Name: </b><?= $row3['fatherName']; ?><br>
                                                    <b>Highest Educational Attainment: </b><?= $row3['fatherSchool']; ?><br>
                                                    <b>Occupation: </b><?= $row3['fatherJob']; ?><br>
                                                    <b>Mobile #: </b><?= $row3['fatherNumber']; ?><br><br>
                                                    <b>Mother' Name: </b><?= $row3['motherName']; ?><br>
                                                    <b>Highest Educational Attainment: </b><?= $row3['motherSchool']; ?><br>
                                                    <b>Job: </b><?= $row3['motherJob']; ?><br>
                                                ...
                                                <div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <!-- Image to be displayed in modal -->
