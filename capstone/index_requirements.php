...
<div class="parallax " ><!---Code is in the head tag---->
		<div class="container py-5 ">
			...
			<div class="text-center pb-5 text-white fade-in1" class="font-size: 20px;"><strong >Train up a child in the way he should
				...
				<div class="row my-5 ms-4 "> 
						...
						<div class="col mt-2 ">
							<div class="card card1" style="width: 18rem;">
								<img src="img/pres.jpg" class="card-img-top" alt="bbq">
								<div class="card-body">
									<h5 class="card-title fw-bold">Bishop Virgilio Bermejo</h5>
									<p class="card-text text-center"> 

										<span class="fst-italic">President</span><br>
										</p>
										<!-- <span class="fst-italic mb-3" style="font-size: 90%;">
											1/2kg - 12pcs. Serves 2-3 people. <br>1kg - 24pcs. Serves 4-5 people.
										</span> -->
						...
						<div class="col mt-2">
							<div class="card card1" style="width: 18rem;">
								<img src="img/vp.jpg" class="card-img-top" alt="bbq">
								<div class="card-body text-center">
									<h5 class="card-title fw-bold">Mrs. Constancia Bermejo</h5>
									<p class="card-text"> 
										<span class=" fst-italic">Vice President</span><br>
										</p>									
								</div>
							</div>
						</div>
						...
						<div class="col mt-2">
							<div class="card card1" style="width: 18rem;">
								<img src="img/prin.jpg" class="card-img-top" alt="bbq">
								<div class="card-body text-center">
									<h5 class="card-title fw-bold">Mrs. Maureen Requiestas</h5>
									<p class="card-text">
										<span class="fst-italic">Principal</span><br>
										</p>
								</div>
							</div>
						</div>
				...
				<!-- <div class="text-center ">
					<a href="#" class="btn btn-outline-warning  fw-bold py-2 px-4 " style="font-size: 120%; margin-buttom: 50%;">Admins</a>
				</div> -->
    ...
    <div class="row p-5">
        <div class="col m-5 code-card fade-in1" >
            <div class="icon-circle ">
                <img src="assets/img/sidebar/icon-2.png" alt="Icon"> <!-- Replace 'your-image.jpg' with your image path -->
            </div>
        ...
        <div class="col m-5 code-card fade-in1" >
            <div class="icon-circle">
                <img src="assets/img/sidebar/icon-3.png" alt="Icon"> <!-- Replace 'your-image.jpg' with your image path -->
            </div>
        ...
        <div class="col m-5 code-card fade-in1" >
            <div class="icon-circle">
                <img src="assets/img/sidebar/icon-12.png" alt="Icon"> <!-- Replace 'your-image.jpg' with your image path -->
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Show the requirements modal when the page is loaded
        var requirementsModal = new bootstrap.Modal(document.getElementById('requirements'));
