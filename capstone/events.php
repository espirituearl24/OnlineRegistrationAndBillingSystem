...
<div class="col-md-6 mb-3"> 
    <label for="level_from" class="form-label mb-5 mt-1 px-2">Grade Level From</label>
    <select class="form-select pt-4" id="level_from" name="level_from" required>
        <option selected disabled></option>
        <option value="Kinder 1">Pre-School</option>
        <option value="Kinder 2">Pre-Kinder</option>
...
<div class="col-md-6 mb-3"> 
    <label for="level_to" class="form-label mb-5 mt-1 px-2">Grade Level To</label>
    <select class="form-select pt-4" id="level_to" name="level_to" required>
        <option selected disabled></option>
        <option value="Kinder 1">Pre-School</option>
        <option value="Kinder 2">Pre-Kinder</option>
        <option value="Grade 1">Grade 1</option>
  ...
  <div class="col-12">
    ...
    if ($events_run) {
        while ($row = $events_run->fetch(PDO::FETCH_ASSOC)) {
            ...
            // Process the level string to create a range
            $levels = explode(',', $row['level']); // Split the levels into an array
            $first_level = $levels[0]; // Get the first level
            $last_level = end($levels); // Get the last level
            
            // Check if first and last levels are the same
            if ($first_level === $last_level) {
                $display_level = $first_level; // If they are the same, just display one
            } else {
                $display_level = $first_level . ' - ' . $last_level; // Otherwise, display the range
            }

            echo "<td>" . $display_level . "</td>"; // Display the formatted level range
