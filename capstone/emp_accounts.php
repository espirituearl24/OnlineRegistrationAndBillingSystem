...
<div class="card-body">
    <div class="table-responsive">
        ...
        <table id="userTable" class="table custom-table">
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM `users` WHERE `type` IN (1, 2, 3, 4)";
                            ...
                            <td>
                                <form action="process.php" method="POST">
                                    <div class="text-center">
                                        <button class="btn btn-success" type="submit" name="reset" onclick="return confirm('Are you sure you want to reset password of <?= $row['firstname']; ?>?');" value="<?= $row['id']; ?>">Reset Password</button>
                                    </div>
                                </form>
                            </td>
                        </tr>
